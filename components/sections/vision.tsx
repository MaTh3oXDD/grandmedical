          ...
          <div className="lg:col-span-10">
            <div className="space-y-16 md:space-y-24">
              ...
              <div className="overflow-hidden">
                ...
                >
                  Wierzymy, ze kompleksowa opieka medyczna powinna byc dostepna, nowoczesna i skoncentrowana na dobrostanie kazdego pacjenta.
                </h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 md:gap-20">
                ...
                >
                  <p className="text-lg md:text-xl leading-relaxed text-foreground/80">
                    Grand Medical Clinic to specjalistyczne centrum medyczne w Lodzi, w ktorym pacjent moze skorzystac z konsultacji specjalistycznych, rehabilitacji oraz leczenia szpitalnego pod jednym dachem.
                  </p>
                </div>
                <div
                  className="space-y-6"
                ...
                >
                  <p className="text-lg md:text-xl leading-relaxed text-foreground/80">
                    Lacząc nowoczesna diagnostyke, intensywna terapie i opieke specjalistyczna, prowadzimy pacjenta od diagnozy az po pelna rekonwalescencje — z indywidualnym podejsciem na kazdym etapie leczenia.
                  </p>
                </div>
              </div>
              ...
              >
                {[
                  ...
                  { value: "NFZ", label: "i komercyjnie" },
                  { value: "24h", label: "Opieka szpitalna" },
                ].map((stat) => (
                  <div key={stat.label} className="space-y-1">
                    <span className="text-4xl md:text-5xl lg:text-7xl font-light text-foreground font-sans">
                      {stat.value}
                    </span>
